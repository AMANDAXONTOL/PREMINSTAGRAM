...
kom1 = ("Anjayy keren banget bang🤘\n-\nhttps://www.facebook.com/100010868886818/posts/1993152504390360/?substory_index=913553553088668&app=fbl\n-\n \nkomentar ditulis oleh bot\n \n[Semangat Bang @[100080706585229:] ]")
...
def menu(my_name,my_id):
	...
	luthfi_tamvan(f'[>] ID  : '+str(my_id))
	luthfi_tamvan(f'[>] IP  : {ip}')
	#luthfi_tamvan(f' Github   : Basari-ID')
	luthfi_tamvan('=' * 40)
	cetak(' [•] 1. Crack Publik Massal\n [•] 2. Crack Followers\n [•] 3. Crack Group\n [•] 4. Hasil Crack\n [•] 5. Chat Author\n [•] 0. Keluar')
	luthfi_tamvan('=' * 40)
	luthfi_tamvan = input('[?] Pilih : ')
	luthfi_tamvan('=' * 40)
	if luthfi_tamvan in ['1']:
		dump_massal()
	elif luthfi_tamvan in ['2']:
		dump_pengikut()
	elif luthfi_tamvan in ['3']:
		grup()
	elif luthfi_tamvan in ['4']:
		result()
	elif luthfi_tamvan in ['5']:
		authorbas()
	elif luthfi_tamvan in ['0']:
		...
		back()
def authorbas():
	luthfi_tamvan(f'{sir}[!] Tunggu Bentar cuk Ntar Diarahin Ke Facebook  {x}')
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/sipalinggantengEXE")
	back()
